...
- [ ] Asuna time recognition and vibe change based on time 🎧
- [ ] Phrase activated photos and instant replay 🎶
- [ ] Error auto-fix/quarantine ❗
- [ ] System logs with the offline Chat-bot being able to read them 📝
- [ ] Gesture recognition that leads to functions being controled without audio 🖐️
- [ ] The hardware running it all 🛠️
